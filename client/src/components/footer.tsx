          ...
          <div>
            ...
            <div className="flex gap-3">
              <a
                ...
                className="w-9 h-9 rounded-full bg-primary/10 text-primary flex items-center justify-center hover-elevate"
                data-testid="link-instagram"
              >
                <SiInstagram className="w-4 h-4" />
              </a>
              <a
                href="https://www.facebook.com/hairartistrysaloncapecoral"
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 rounded-full bg-primary/10 text-primary flex items-center justify-center hover-elevate"
            ...
            <div className="space-y-2">
              {[
                ...
                <Link key={link.href} href={link.href}>
                  <span className="block text-sm text-muted-foreground cursor-pointer py-1" data-testid={`link-footer-${link.label.toLowerCase()}`}>
                    {link.label}
                  </span>
                </Link>
              ))}
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-2 text-sm">
                ...
                <a href="tel:+12396779902" className="text-muted-foreground" data-testid="text-footer-phone">
                  (239) 677-9902
                </a>
              </div>
              <div className="flex items-start gap-2 text-sm">
                ...
                <span className="text-muted-foreground" data-testid="text-footer-address">
                  909 SE 47th Terr<br />Cape Coral, FL 33904 #104
                </span>
              </div>
              <div className="flex items-start gap-2 text-sm">
      ...
      <div className="border-t border-border">
        <div className="max-w-6xl mx-auto px-4 py-4">
          <p className="text-xs text-muted-foreground text-center" data-testid="text-copyright">
            Hair Artistry Full Service Salon &middot; Cape Coral, FL
          </p>
        </div>
      </div>
    </footer>
