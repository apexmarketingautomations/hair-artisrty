...
const services = [
  ...
  { icon: Crown, title: "Men's Grooming", description: "Scissor cuts, precision fades, straight razor shaves with hot towel treatment, beard grooming, and more. Sharp looks for the modern gentleman.", tag: null, category: "cuts" as Category, image: null },
  { icon: Flower2, title: "Braids & Installs", description: "Knotless braids, box braids, cornrows, wig installs, custom units, and extensions including hand-tied, sew-in, and tape-in options.", tag: null, category: "braids" as Category, image: null },
  { icon: Scissors, title: "Kids' Cuts", description: "Fresh, fun styles for little ones in a comfortable, friendly environment. We make sure your kids leave looking and feeling great.", tag: null, category: "cuts" as Category, image: null },
  { icon: Heart, title: "Bridal Services", description: "Your dream wedding hair, perfected. In-salon or we travel to you. Trial runs, updos, blowouts, and styling for the entire bridal party.", tag: "Premium", category: "specialty" as Category, image: null },
  { icon: Waves, title: "Scalp Therapy Experience", description: "Luxe 1-hour scalp treatment featuring massage bed bliss, two nourishing hair masks, a refreshing facial, and a blowout of your choice.", tag: "Luxe", category: "specialty" as Category, image: null },
  { icon: Droplets, title: "Waxing Services", description: "Eyebrows, lips, chin, sideburns, and full face waxing. Professional waxing for smooth, clean results every time.", tag: null, category: "specialty" as Category, image: null },
  { icon: Palette, title: "Color Corrections", description: "Expert color correction services to fix unwanted tones, banding, or damage from previous color treatments. We'll get you where you want to be.", tag: null, category: "color" as Category, image: null },
];
